...
"use strict";
eval("\n\nvar __values = this && this.__values || function (o) {\n  var m = typeof Symbol === \"function\" && o[Symbol.iterator],\n      i = 0;\n  if (m) return m.call(o);\n  return {\n    next: function next() {\n      if (o && i >= o.length) o = void 0;\n      return {\n        value: o && o[i++],\n        done: !o\n      };\n    }\n  };\n};\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar contact_1 = __webpack_require__(/*! ../contact */ \"./src/contact.ts\");\n\nvar ContactDB =\n/** @class */\nfunction () {\n  function ContactDB(email) {\n    if (!this.contactKeys || !this.contacts) {\n      this.contacts = new Map();\n      this.contactKeys = new Set();\n      this.loadContactKeys(email);\n      this.loadAllContactsFromStorage();\n    }\n  }\n\n  ContactDB.prototype.getContact = function (key) {\n    if (this.contactKeys.has(key)) {\n      return this.contacts.get(key);\n    }\n\n    return {\n      error: \"Contact does not exist!\"\n    };\n  };\n\n  ContactDB.prototype.getAllContacts = function () {\n    return this.contacts;\n  };\n\n  ContactDB.prototype.saveContacts = function (email) {\n    this.saveContactsToStorage(email);\n  };\n\n  ContactDB.prototype.insertContact = function (key, contact) {\n    if (this.contactKeys.add(key)) {\n      this.contacts.set(key, contact);\n      return true;\n    }\n\n    return {\n      error: \"Failed to add contact. A contact may already exist with that number.\"\n    };\n  };\n\n  ContactDB.prototype.deleteContact = function (key) {\n    if (this.contactKeys.has(key)) {\n      this.contactKeys.delete(key);\n      this.contacts.delete(key);\n      return true;\n    } else {\n      return {\n        error: \"Failed to delete contact. Probably did not exist.\"\n      };\n    }\n  };\n\n  ContactDB.prototype.loadContactKeys = function (email) {\n    if (window.localStorage) {\n      console.log(\"Loading contact keys from storage... for \" + email);\n      var contactKeys = void 0;\n\n      if (contactKeys = window.localStorage.getItem(String(email))) {\n        this.contactKeys = new Set(JSON.parse(contactKeys));\n        console.log(\"Contact keys are => \" + contactKeys);\n      }\n\n      console.log(\"Finished loading keys from storage\");\n    } else {\n      console.log(\"Local storage not supported\");\n      return {\n        error: \"Local storage not supported\"\n      };\n    }\n  };\n\n  ContactDB.prototype.loadAllContactsFromStorage = function () {\n    var e_1, _a;\n\n    if (window.localStorage) {\n      console.log(\"Loading all contacts from storage...\" + this.contactKeys.size);\n\n      if (this.contactKeys.size > 0) {\n        try {\n          for (var _b = __values(this.contactKeys.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {\n            var key = _c.value;\n            var contact = void 0;\n            console.log(\"Key is =>\" + key.toString());\n\n            if (contact = window.localStorage.getItem(String(key))) {\n              console.log(\"Loaded contact is \" + contact);\n              var loadedContact = JSON.parse(contact);\n              this.contacts.set(key, new contact_1.Contact(loadedContact.firstName, loadedContact.lastName, loadedContact.phoneNumber, loadedContact.phoneNumber));\n            }\n          }\n        } catch (e_1_1) {\n          e_1 = {\n            error: e_1_1\n          };\n        } finally {\n          try {\n            if (_c && !_c.done && (_a = _b.return)) _a.call(_b);\n          } finally {\n            if (e_1) throw e_1.error;\n          }\n        }\n\n        console.log(\"All loaded contacts => \" + this.contacts.size);\n        return this.contacts;\n      } else {\n        return new Map();\n      }\n    } else {\n      console.log(\"Local storage not supported\");\n      return {\n        error: \"Local storage not supported\"\n      };\n    }\n  };\n\n  ContactDB.prototype.saveContactsToStorage = function (email) {\n    var e_2, _a;\n\n    if (window.localStorage) {\n      var keys = [];\n\n      try {\n        for (var _b = __values(this.contactKeys.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {\n          var key = _c.value;\n          keys.push(key);\n          window.localStorage.setItem(String(key), JSON.stringify(this.contacts.get(key)));\n        }\n      } catch (e_2_1) {\n        e_2 = {\n          error: e_2_1\n        };\n      } finally {\n        try {\n          if (_c && !_c.done && (_a = _b.return)) _a.call(_b);\n        } finally {\n          if (e_2) throw e_2.error;\n        }\n      }\n\n      window.localStorage.setItem(String(email), JSON.stringify(keys));\n      console.log(\"Contacts saved.\"); //Add return to check if save was successful to notify user \n    } else {\n      console.log(\"Local storage not supported\");\n      return {\n        error: \"Local storage not supported\"\n      };\n    }\n  };\n\n  ContactDB.prototype.autoSave = function () {};\n\n  return ContactDB;\n}();\n\nexports.ContactDB = ContactDB;\n\n//# sourceURL=webpack:///./src/models/contactsdb.models.ts?");

/***/ }),

/***/ "./src/models/userdb.model.ts":
/*!************************************!*\
  !*** ./src/models/userdb.model.ts ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar userdb_model_1 = __webpack_require__(/*! ../models/userdb.model */ \"./src/models/userdb.model.ts\");\n\nvar accessmgmt_service_1 = __webpack_require__(/*! ./accessmgmt.service */ \"./src/services/accessmgmt.service.ts\");\n\nvar Authenticator =\n/** @class */\nfunction () {\n  function Authenticator() {\n    this.accessMgmt = new accessmgmt_service_1.AccessMgmt();\n  }\n\n  Authenticator.prototype.login = function (email, password) {\n    var db = new userdb_model_1.UserDB();\n    var results = Object(db.getUserByEmail(email));\n\n    if (results != null) {\n      if (results.error) {\n        return results;\n      } else {\n        if (password === results.password) {\n          return {\n            success: true,\n            accessToken: this.accessMgmt.getAccessToken(email),\n            session: this.accessMgmt.createSession(email)\n          };\n        } else {\n          return {\n            error: \"Email or password does not match.\",\n            code: 401\n          };\n        }\n      }\n    } else {\n      console.log(\"Database connection failed.\");\n      return 500;\n    }\n  };\n\n  Authenticator.prototype.logout = function () {\n    this.accessMgmt.destroySession();\n  };\n\n  Authenticator.prototype.isLoggedIn = function () {\n    return this.accessMgmt.checkSession();\n  };\n\n  Authenticator.prototype.verifyAccess = function (email, token) {\n    // console.log(\"Entered verifyAccess in Authenticator with token: \"+token);\n    var result = this.accessMgmt.verifyAccess(token); // console.log(\"Verify access called:\" + email + \", \" + hash);\n\n    return result;\n  };\n\n  Authenticator.prototype.renewAccess = function (email) {\n    return this.accessMgmt.getAccessToken(email);\n  };\n\n  return Authenticator;\n}();\n\nexports.Authenticator = Authenticator;\n\n//# sourceURL=webpack:///./src/services/authenticator.service.ts?");
